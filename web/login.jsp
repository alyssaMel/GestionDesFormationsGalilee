...
<%--<jsp:include page="resources/css/common.css"/>--%>
    ...
    <body>
        ...
        <div id="wrapper">
            <form method="post" action="j_spring_security_check" class="login-form">
                <div class="header">
                    <h1> Se Connecter </h1>
                    <span> Merci de bien vouloir mentionner votre nom d'utilisateur et votre mot de passe </span>
                </div>
                <div class="content">   
                    <input name="j_username" value="Username" type="text" class="input username"/>
                    <div class="user-icon"></div>
                    <input name="j_password" type="password" class="input password" value="Password"/>
                    <div class="pass-icon"></div>		
                </div>

                <div class="footer">
                    <input value="Valider" type="submit" class="button"/>                    
                </div>
